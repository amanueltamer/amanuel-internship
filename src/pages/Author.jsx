        ...
        <section aria-label="section">
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12" key={authorItem.id}>
                    ...
                    <div className="profile_avatar">
                      ...
                      <div className="profile_name">
                        <h4>
                          ...
                          <span className="profile_username">@{authorItem.tag}</span>
                ...
                <div className="d_profile de-flex">
                  <div className="de-flex-col">
                    <div className="profile_avatar">
                      ...
                      <i className="fa fa-check"></i>
                      <div className="profile_name" style={{ marginTop: "16px", display: "flex", flexDirection: "column", gap: "18px", alignItems: "flex-start"}}>
                        <Skeleton width="200px" height="28px" borderRadius="4px" />
                        <Skeleton width="120px" height="16px" borderRadius="4px" style={{ marginTop: "6px" }} />
                        <Skeleton width="300px" height="16px" borderRadius="4px" style={{ marginTop: "6px" }} />
                      </div>
                    </div>
                  </div>
                  <div className="profile_follow de-flex">
                    <div className="de-flex-col" style={{ marginLeft: "24px", display: "flex", gap: "12px"}}>
                      <Skeleton width="80px" height="16px" borderRadius="4px" />
                      <Skeleton width="100px" height="36px" borderRadius="6px" style={{ marginTop: "8px" }} />
                    </div>
                  </div>
                </div>
              </div>
